...
data class Person(
    ...
    class Builder {
        ...
        fun company(company: String): Builder =
            run {
                this.company = company
                this
            }

        fun skills(action: Skills.Builder.() -> Unit): Builder =
            run {
                Skills.Builder().apply(action).build()
                return this
            }

        fun languages(action: Languages.Builder.() -> Unit): Builder =
            run {
                Languages.Builder().apply(action).build()
                return this
            }

...
class BetAmountTest {
    ...
    fun `승리하고 블랙잭이 아닌 경우 베팅금만큼 받는다`() {
        // when
        val actual = betAmount.calculateProceed(GameResult.Win, false)
        val expected = 10000
        // then
    ...
    fun `승리하고 블랙잭인 경우 베팅금의 150%를 받는다`() {
        // when
        val actual = betAmount.calculateProceed(GameResult.Win, true)
        val expected = 15000
        // then
        assertThat(actual).isEqualTo(expected)
    }
    ...
    fun `패배인 경우 베팅금을 잃는다`() {
        // when
        val actual = betAmount.calculateProceed(GameResult.Lose, false)
        val expected = -10000
        // then
        assertThat(actual).isEqualTo(expected)
    }

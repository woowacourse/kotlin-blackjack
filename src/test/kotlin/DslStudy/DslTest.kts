...
class SkillsBuilder {
    ...
    fun build(): Skill {
        return Skill(softItems, hardItems)
    }
}
...
data class Person(val name: String, val company: String?, val skill: Skill, val languages: Map<String, Int>)
data class Skill(val softSkill: List<String>, val hardSkill: List<String>)

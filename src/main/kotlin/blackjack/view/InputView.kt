...
class InputView {
    ...
    fun getBettingAmount(name: String): Int {
        println()
        println(BETTING_AMOUNT_MESSAGE.format(name))
        return readUserInput().toIntOrNull() ?: throw IllegalArgumentException(INVALID_AMOUNT_MESSAGE)
    }

    fun getUserChoice(name: String): Boolean {
    ...
    companion object {
        ...
        private const val BETTING_AMOUNT_MESSAGE = "%s의 배팅 금액은?"
        private const val INVALID_AMOUNT_MESSAGE = "배팅 금액은 숫자만 입력할 수 있습니다."

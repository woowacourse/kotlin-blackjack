...
class Players2 private constructor(names: Set<String>) {
    val gamePlayers: List<Player2> = names.map { Player2(it) }
    ...
    fun playTurn(
        ...
        val gameResults = mutableMapOf<Player2, Finish>()
        gamePlayers.forEach { player ->
    ...
    companion object {
        ...
        fun withInitCards(
            ...
            return Players2(names.toSet()).also { it.initPlayersCard(deck) }
        }

...
## 🛠️ step2 기능 요구사항
- [x] 플레이어들은 금액을 배팅할 수 있다.
- [x] Bust되어 21을 넘는 경우 배팅 금액을 모두 잃는다
- [x] 처음 두 장의 카드 합이 21이되면, 베팅 금액의 1.5배를 딜러에게 받는다
- [x] 딜러와 플레이어가 동시에 블랙잭이면 베팅한 금액을 돌려받는다

게임 매니저? 아니면 각각의 게임 플레이어는 사실 돈을 가지고 있어야하나? 

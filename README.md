...
- [X] 이름을 입력받는다.
- [X] 이름은 1~5자 사이이다.
- [X] 사람은 1 ~ 8명까지 입력받을 수 있다.
- [X] 사람별로 베팅 금액을 설정할 수 있다.
- [X] 카드를 한장 나누어준다.
- [X] 딜러와 플레이어에게 카드 2장을 나누어 준다.
- [X] 딜러는 한장의 카드만 보여준다.
- [X] 플레이어는 2장의 카드를 보여준다.
블랙잭이 있는 경우
- [X] 딜러의 카드가 블랙잭이면 배팅이 종료된다.
- [X] 딜러의 카드가 블랙잭이고 플레이어가 블랙잭인 경우 베팅한 금액을 돌려받는다.
- [X] 플레이어의 카드가 블랙잭인 경우 베팅의 금액의 1.5배를 딜러에게 받는다. 
- [X] 나머지 플레이어는 게임을 진행한다.
블랙잭이 없는 경우
- [X] 플레이어에게 묻습니다. 카드 한장을 더 받을 것이냐고 대답은 y, n로 합니다.
- [X] 플레이어가 y라고 답변을 하면, 카드를 준다.
- [X] 카드를 받고 총합이 21이면 카드를 보여준다.
- [X] 카드의 총합이 21초과면 버스트이다. -> 베팅한 금액을 잃는다.
- [X] 카드의 합이 21이 아니면 계속 받을 수 있다.
- [X] 플레이어가 n라고 답변을 하면, 카드를 보여준다.

딜러
- [X] 딜러는 16이하면 카드를 더 받는다.
- [X] 딜러가 21초과하면 그 시점까지 남아 있던 플레이어들은 가지고 있는 패와 상관없이 승리해 배팅 금액을 돌려받는다.
- [X] 블랙잭과 버스트와 스테이에서 카드를 받으면 에러를 반환한다
